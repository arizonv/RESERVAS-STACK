    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='canchas', to='services.tipocancha')),
            ],
            options={
                'verbose_name': 'Cancha',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancha', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.cancha')),
                ('horario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.horario')),
            ],
            options={
                'verbose_name': 'Agenda',
